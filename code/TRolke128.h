...
//  and the syntax, consult TRolke128.cxx
//                  ------------------
//
...
#ifndef ROOT_TRolke128
#define ROOT_TRolke128
...
class TRolke128 //: public TObject
{
...
public:
   ...
   /* Constructor */
   TRolke128(__float128 CL = 0.9, Option_t *option = "");
   ...
   /* Get the bounding mode flag. True activates bounded mode. Read
      TRolke128.cxx and the references therein for details. */
