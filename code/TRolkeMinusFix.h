...
//  and the syntax, consult TRolkeMinusFix.cxx
//                  ------------------
//
...
// #ifndef ROOT_TRolkeMinusFix
// #define ROOT_TRolkeMinusFix
 
#include "TObject.h"
#include "TMath.h"
 
// Class definition. This class is not intended to be used as a base class.
class TRolkeMinusFix // : public TObject
{
...
public:
   ...
   /* Constructor */
   TRolkeMinusFix(Double_t CL = 0.9, Option_t *option = "");
   ...
   /* Get the bounding mode flag. True activates bounded mode. Read
      TRolkeMinusFix.cxx and the references therein for details. */
   ...
   // ClassDefOverride(TRolkeMinusFix, 2)
};
