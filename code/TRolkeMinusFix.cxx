...
/** \class TRolkeMinusFix
    \legacy{TRolkeMinusFix, Consider switching to RooStats.}
    \ingroup Physics
...
\author Jan Conrad (CERN) 2004, Updated: Johan Lundberg (CERN) 2009
 ...
 consult the header file TRolkeMinusFix.h.
 
 Examples/tutorials are found in the separate file Rolke.C
 
### TRolkeMinusFix implements the following Models
...
~~~
 ...
 The TRolkeMinusFix method is very similar to the one used in MINUIT (MINOS).
...
#### Should I use TRolkeMinusFix, TFeldmanCousins, TLimit?
 
   1. Does TRolkeMinusFix make TFeldmanCousins obsolete?
      ...
      TRolkeMinusFix is designed for this case and it is shown in the reference above
      that it has good coverage properties for most cases, and can be used
      where FeldmannCousins can't.
 
   2. What are the advantages of TRolkeMinusFix over TLimit?
      TRolkeMinusFix is fully frequentist. TLimit treats nuisance parameters Bayesian.
...
// ClassImp(TRolkeMinusFix);
 
////////////////////////////////////////////////////////////////////////////////
/// Constructor with optional Confidence Level argument.
/// 'option' is not used.
 
TRolkeMinusFix::TRolkeMinusFix(Double_t CL, Option_t * /*option*/)
:  fCL(CL),
   fUpperLimit(0.0),
   fLowerLimit(0.0),
...
///   - y   : number of observed events in background region
///   - z   : number of MC events observed
///   - tau : ratio parameter (read TRolkeMinusFix.cxx for details)
///   - m   : number of MC events generated
 
void TRolkeMinusFix::SetPoissonBkgBinomEff(Int_t x, Int_t y, Int_t z, Double_t tau, Int_t m)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolkeMinusFix::SetPoissonBkgGaussEff(Int_t x, Int_t y, Double_t em, Double_t tau, Double_t sde)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolkeMinusFix::SetGaussBkgGaussEff(Int_t x, Double_t bm, Double_t em, Double_t sde, Double_t sdb)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y,
...
void TRolkeMinusFix::SetPoissonBkgKnownEff(Int_t x, Int_t y, Double_t tau, Double_t e)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolkeMinusFix::SetGaussBkgKnownEff(Int_t x, Double_t bm, Double_t sdb, Double_t e)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y,
...
void TRolkeMinusFix::SetKnownBkgBinomEff(Int_t x, Int_t z, Int_t m, Double_t b)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y
...
void TRolkeMinusFix::SetKnownBkgGaussEff(Int_t x, Double_t em, Double_t sde, Double_t b)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y
...
bool TRolkeMinusFix::GetLimits(Double_t& low, Double_t& high)
{
   if ((f_mid<1)||(f_mid>7)) {
      std::cerr << "TRolkeMinusFix - Error: Model id "<< f_mid<<std::endl;
      if (f_mid<1) {
         std::cerr << "TRolkeMinusFix - Please specify a model with e.g. 'SetGaussBkgGaussEff' (read the docs in Rolke.cxx )"<<std::endl;
      }
      return false;
   }
   ...
   if (low < high) {
      ...
      std::cerr << "TRolkeMinusFix - Warning: no limits found" <<std::endl;
      return false;
   }
}
...
Double_t TRolkeMinusFix::GetUpperLimit()
{
...
Double_t TRolkeMinusFix::GetLowerLimit()
{
   Double_t low(0), high(0);
   GetLimits(low,high);
   return fLowerLimit;
...
Double_t TRolkeMinusFix::GetBackground()
{
   ...
   switch (f_mid) {
      ...
      case 7:
         ...
         break;
      default:
         std::cerr << "TRolkeMinusFix::GetBackground(): Model NR: " <<
...
bool TRolkeMinusFix::GetSensitivity(Double_t& low, Double_t& high, Double_t pPrecision)
{
...
bool TRolkeMinusFix::GetLimitsQuantile(Double_t& low, Double_t& high, Int_t& out_x, Double_t integral)
{
   Double_t background = GetBackground();
   Double_t weight = 0;
   Double_t weightSum = 0;
...
bool TRolkeMinusFix::GetLimitsML(Double_t& low, Double_t& high, Int_t& out_x)
{
   Double_t background = GetBackground();
...
bool TRolkeMinusFix::GetCriticalNumber(Int_t& ncrit, Int_t maxtry)
{
   Double_t background = GetBackground();
   ...
   if (rolke_ncrit == -1) {
     std::cerr << "TRolkeMinusFix GetCriticalNumber : Error: problem finding rolke inverse. Specify a larger maxtry value. maxtry was: " << maxj << ". highest x considered was j "<< j<< std::endl;
      ncrit = -1;
      return false;
   } else {
      ncrit = rolke_ncrit;
...
void TRolkeMinusFix::SetSwitch(bool bnd) {
   if(fNumWarningsDeprecated1<2){
      std::cerr << "*******************************************" <<std::endl;
      std::cerr << "TRolkeMinusFix - Warning: 'SetSwitch' is deprecated and may be removed from future releases:" <<std::endl;
...
void TRolkeMinusFix::Print(Option_t*) const {
   std::cout << "*******************************************" <<std::endl;
   std::cout << "* TRolkeMinusFix::Print() - dump of internals:                " <<std::endl;
   std::cout << "*"<<std::endl;
...
Double_t TRolkeMinusFix::CalculateInterval(Int_t x, Int_t y, Int_t z, Double_t bm, Double_t em, Double_t e, Int_t mid, Double_t sde, Double_t sdb, Double_t tau, Double_t b, Int_t m){
   if (fNumWarningsDeprecated2<2 ) {
      std::cerr << "*******************************************" <<std::endl;
      std::cerr << "TRolkeMinusFix - Warning: 'CalculateInterval' is deprecated and may be removed from future releases:" <<std::endl;
...
void TRolkeMinusFix::SetModelParameters(Int_t x, Int_t y, Int_t z, Double_t bm, Double_t em, Double_t e, Int_t mid, Double_t sde, Double_t sdb, Double_t tau, Double_t b, Int_t m)
{
   f_x   = x   ;
   f_y   = y   ;
   f_z   = z   ;
...
void TRolkeMinusFix::SetModelParameters()
{
...
Double_t TRolkeMinusFix::ComputeInterval(Int_t x, Int_t y, Int_t z, Double_t bm, Double_t em, Double_t e, Int_t mid, Double_t sde, Double_t sdb, Double_t tau, Double_t b, Int_t m)
{
   //calculate interval
   Int_t done = 0;
   Double_t limit[2];
...
Double_t TRolkeMinusFix::Interval(Int_t x, Int_t y, Int_t z, Double_t bm, Double_t em, Double_t e, Int_t mid, Double_t sde, Double_t sdb, Double_t tau, Double_t b, Int_t m)
{
...
Double_t TRolkeMinusFix::Likelihood(Double_t mu, Int_t x, Int_t y, Int_t z, Double_t bm, Double_t em, Int_t mid, Double_t sde, Double_t sdb, Double_t tau, Double_t b, Int_t m, Int_t what)
{
   switch (mid) {
      case 1:
      ...
      default:
         std::cerr << "TRolkeMinusFix::Likelihood(...): Model NR: " <<
         f_mid << " unknown"<<std::endl;
         return 0;
   }
...
Double_t TRolkeMinusFix::EvalLikeMod1(Double_t mu, Int_t x, Int_t y, Int_t z, Double_t tau, Int_t m, Int_t what)
{
   Double_t f  = 0;
...
Double_t TRolkeMinusFix::LikeMod1(Double_t mu, Double_t b, Double_t e, Int_t x, Int_t y, Int_t z, Double_t tau, Int_t m)
{
   double s = e*mu+b;
   double lls = - s;
...
void TRolkeMinusFix::ProfLikeMod1(Double_t mu, Double_t &b, Double_t &e, Int_t x, Int_t y, Int_t z, Double_t tau, Int_t m)
{
...
Double_t TRolkeMinusFix::LikeGradMod1(Double_t e, Double_t mu, Int_t x, Int_t y, Int_t z, Double_t tau, Int_t m)
{
...
Double_t TRolkeMinusFix::EvalLikeMod2(Double_t mu, Int_t x, Int_t y, Double_t em, Double_t sde, Double_t tau, Int_t what)
{
   Double_t v =  sde * sde;
...
Double_t TRolkeMinusFix::LikeMod2(Double_t mu, Double_t b, Double_t e, Int_t x, Int_t y, Double_t em, Double_t tau, Double_t v)
{
   double s = e*mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalLikeMod3(Double_t mu, Int_t x, Double_t bm, Double_t em, Double_t sde, Double_t sdb, Int_t what)
{
   Double_t f = 0.;
   Double_t  v = sde * sde;
   Double_t  u = sdb * sdb;
...
Double_t TRolkeMinusFix::LikeMod3(Double_t mu, Double_t b, Double_t e, Int_t x, Double_t bm, Double_t em, Double_t u, Double_t v)
{
   double s = e*mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalLikeMod4(Double_t mu, Int_t x, Int_t y, Double_t tau, Int_t what)
{
   Double_t f = 0.0;
...
Double_t TRolkeMinusFix::LikeMod4(Double_t mu, Double_t b, Int_t x, Int_t y, Double_t tau)
{
   double s = mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalLikeMod5(Double_t mu, Int_t x, Double_t bm, Double_t sdb, Int_t what)
{
   Double_t u = sdb * sdb;
   Double_t f = 0;
...
Double_t TRolkeMinusFix::LikeMod5(Double_t mu, Double_t b, Int_t x, Double_t bm, Double_t u)
{
   double s = mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalLikeMod6(Double_t mu, Int_t x, Int_t z, Double_t b, Int_t m, Int_t what)
{
   Double_t coef[4], roots[3];
   Double_t f = 0.;
   Double_t zm = Double_t(z) / m;
...
Double_t TRolkeMinusFix::LikeMod6(Double_t mu, Double_t b, Double_t e, Int_t x, Int_t z, Int_t m)
{
   double s = e*mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalLikeMod7(Double_t mu, Int_t x, Double_t em, Double_t sde, Double_t b, Int_t what)
{
   Double_t v = sde * sde;
   Double_t f = 0.;
...
Double_t TRolkeMinusFix::LikeMod7(Double_t mu, Double_t b, Double_t e, Int_t x, Double_t em, Double_t v)
{
   double s = e*mu+b;
   double lls = - s;
   if (x > 0) lls = x*TMath::Log(s) - s - LogFactorial(x);
...
Double_t TRolkeMinusFix::EvalPolynomial(Double_t x, const Int_t  coef[], Int_t N)
{
   const Int_t   *p;
   p = coef;
   Double_t ans = *p++;
...
Double_t TRolkeMinusFix::EvalMonomial(Double_t x, const Int_t coef[], Int_t N)
{
   Double_t ans;
   const Int_t   *p;
...
Double_t TRolkeMinusFix::LogFactorial(Int_t n)
{
