...
int main(int argc, char **argv) {
    ...
    // int x, y, i_begin, i_end;
    // std::cin >> x >> y >> i_begin >> i_end;
    ...
    // }
    auto canvas0 = new TCanvas("canvas0", "canvas0", 1500, 1000);
    canvas0->Divide(2, 2);
    ...
    auto canvas1 = new TCanvas("canvas1", "canvas1", 1500, 1000);
    canvas1->Divide(2, 2);
    ...
    auto canvas2 = new TCanvas("canvas2", "canvas2", 1500, 1000);
    canvas2->Divide(2, 1);
