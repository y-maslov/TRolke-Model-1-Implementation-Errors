...
//  and the syntax, consult TRolkeDefault.cxx
//                  ------------------
//
...
// #ifndef ROOT_TRolkeDefault
// #define ROOT_TRolkeDefault
 
#include "TObject.h"
#include "TMath.h"
 
// Class definition. This class is not intended to be used as a base class.
class TRolkeDefault // : public TObject
{
...
public:
   ...
   /* Constructor */
   TRolkeDefault(Double_t CL = 0.9, Option_t *option = "");
   ...
   /* Get the bounding mode flag. True activates bounded mode. Read
      TRolkeDefault.cxx and the references therein for details. */
   ...
   // ClassDefOverride(TRolkeDefault, 2)
};
