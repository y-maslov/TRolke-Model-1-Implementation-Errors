...
/** \class TRolke128
    \legacy{TRolke128, Consider switching to RooStats.}
    \ingroup Physics
...
\author Jan Conrad (CERN) 2004, Updated: Johan Lundberg (CERN) 2009
 ...
 consult the header file TRolke128.h.
 
 Examples/tutorials are found in the separate file Rolke.C
 
### TRolke128 implements the following Models
...
~~~
 ...
 The TRolke128 method is very similar to the one used in MINUIT (MINOS).
...
#### Should I use TRolke128, TFeldmanCousins, TLimit?
 
   1. Does TRolke128 make TFeldmanCousins obsolete?
      ...
      TRolke128 is designed for this case and it is shown in the reference above
      that it has good coverage properties for most cases, and can be used
      where FeldmannCousins can't.
 
   2. What are the advantages of TRolke128 over TLimit?
      TRolke128 is fully frequentist. TLimit treats nuisance parameters Bayesian.
...
TRolke128::TRolke128(__float128 CL, Option_t * /*option*/)
:  fCL(CL),
   fUpperLimit(0.0),
   fLowerLimit(0.0),
...
///   - y   : number of observed events in background region
///   - z   : number of MC events observed
///   - tau : ratio parameter (read TRolke128.cxx for details)
///   - m   : number of MC events generated
 
void TRolke128::SetPoissonBkgBinomEff(Int_t x, Int_t y, Int_t z, __float128 tau, Int_t m)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolke128::SetPoissonBkgGaussEff(Int_t x, Int_t y, __float128 em, __float128 tau, __float128 sde)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolke128::SetGaussBkgGaussEff(Int_t x, __float128 bm, __float128 em, __float128 sde, __float128 sdb)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y,
...
void TRolke128::SetPoissonBkgKnownEff(Int_t x, Int_t y, __float128 tau, __float128 e)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         y  ,       //   Int_t y,
...
void TRolke128::SetGaussBkgKnownEff(Int_t x, __float128 bm, __float128 sdb, __float128 e)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y,
...
void TRolke128::SetKnownBkgBinomEff(Int_t x, Int_t z, Int_t m, __float128 b)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y
...
void TRolke128::SetKnownBkgGaussEff(Int_t x, __float128 em, __float128 sde, __float128 b)
{
   SetModelParameters(
         x  ,       //   Int_t x,
         0  ,       //   Int_t y
...
bool TRolke128::GetLimits(__float128& low, __float128& high)
{
   if ((f_mid<1)||(f_mid>7)) {
      std::cerr << "TRolke128 - Error: Model id "<< f_mid<<std::endl;
      if (f_mid<1) {
         std::cerr << "TRolke128 - Please specify a model with e.g. 'SetGaussBkgGaussEff' (read the docs in Rolke.cxx )"<<std::endl;
      }
      return false;
   }
   ...
   if (low < high) {
      ...
      std::cerr << "TRolke128 - Warning: no limits found" <<std::endl;
      return false;
   }
}
...
__float128 TRolke128::GetUpperLimit()
{
...
__float128 TRolke128::GetLowerLimit()
{
   __float128 low(0), high(0);
   GetLimits(low,high);
   return fLowerLimit;
...
__float128 TRolke128::GetBackground()
{
   ...
   switch (f_mid) {
      ...
      case 7:
         ...
         break;
      default:
         std::cerr << "TRolke128::GetBackground(): Model NR: " <<
...
bool TRolke128::GetSensitivity(__float128& low, __float128& high, __float128 pPrecision)
{
...
bool TRolke128::GetLimitsQuantile(__float128& low, __float128& high, Int_t& out_x, __float128 integral)
{
   __float128 background = GetBackground();
   __float128 weight = 0;
   __float128 weightSum = 0;
...
bool TRolke128::GetLimitsML(__float128& low, __float128& high, Int_t& out_x)
{
   __float128 background = GetBackground();
...
bool TRolke128::GetCriticalNumber(Int_t& ncrit, Int_t maxtry)
{
   __float128 background = GetBackground();
   ...
   if (rolke_ncrit == -1) {
     std::cerr << "TRolke128 GetCriticalNumber : Error: problem finding rolke inverse. Specify a larger maxtry value. maxtry was: " << maxj << ". highest x considered was j "<< j<< std::endl;
      ncrit = -1;
      return false;
   } else {
      ncrit = rolke_ncrit;
...
void TRolke128::SetSwitch(bool bnd) {
   if(fNumWarningsDeprecated1<2){
      std::cerr << "*******************************************" <<std::endl;
      std::cerr << "TRolke128 - Warning: 'SetSwitch' is deprecated and may be removed from future releases:" <<std::endl;
...
void TRolke128::Print(Option_t*) const {
   std::cout << "*******************************************" <<std::endl;
   std::cout << "* TRolke128::Print() - dump of internals:                " <<std::endl;
   std::cout << "*"<<std::endl;
...
__float128 TRolke128::CalculateInterval(Int_t x, Int_t y, Int_t z, __float128 bm, __float128 em, __float128 e, Int_t mid, __float128 sde, __float128 sdb, __float128 tau, __float128 b, Int_t m){
   if (fNumWarningsDeprecated2<2 ) {
      std::cerr << "*******************************************" <<std::endl;
      std::cerr << "TRolke128 - Warning: 'CalculateInterval' is deprecated and may be removed from future releases:" <<std::endl;
...
void TRolke128::SetModelParameters(Int_t x, Int_t y, Int_t z, __float128 bm, __float128 em, __float128 e, Int_t mid, __float128 sde, __float128 sdb, __float128 tau, __float128 b, Int_t m)
{
   f_x   = x   ;
   f_y   = y   ;
   f_z   = z   ;
...
void TRolke128::SetModelParameters()
{
...
__float128 TRolke128::ComputeInterval(Int_t x, Int_t y, Int_t z, __float128 bm, __float128 em, __float128 e, Int_t mid, __float128 sde, __float128 sdb, __float128 tau, __float128 b, Int_t m)
{
   //calculate interval
   Int_t done = 0;
   __float128 limit[2];
...
__float128 TRolke128::Interval(Int_t x, Int_t y, Int_t z, __float128 bm, __float128 em, __float128 e, Int_t mid, __float128 sde, __float128 sdb, __float128 tau, __float128 b, Int_t m)
{
...
__float128 TRolke128::Likelihood(__float128 mu, Int_t x, Int_t y, Int_t z, __float128 bm, __float128 em, Int_t mid, __float128 sde, __float128 sdb, __float128 tau, __float128 b, Int_t m, Int_t what)
{
   switch (mid) {
      case 1:
      ...
      default:
         std::cerr << "TRolke128::Likelihood(...): Model NR: " <<
         f_mid << " unknown"<<std::endl;
         return 0;
   }
...
__float128 TRolke128::EvalLikeMod1(__float128 mu, Int_t x, Int_t y, Int_t z, __float128 tau, Int_t m, Int_t what)
{
   __float128 f  = 0;
...
__float128 TRolke128::LikeMod1(__float128 mu, __float128 b, __float128 e, Int_t x, Int_t y, Int_t z, __float128 tau, Int_t m)
{
   __float128 s = e*mu+b;
   __float128 lls = - s;
...
void TRolke128::ProfLikeMod1(__float128 mu, __float128 &b, __float128 &e, Int_t x, Int_t y, Int_t z, __float128 tau, Int_t m)
{
...
__float128 TRolke128::LikeGradMod1(__float128 e, __float128 mu, Int_t x, Int_t y, Int_t z, __float128 tau, Int_t m)
{
...
__float128 TRolke128::EvalLikeMod2(__float128 mu, Int_t x, Int_t y, __float128 em, __float128 sde, __float128 tau, Int_t what)
{
...
__float128 TRolke128::LikeMod2(__float128 mu, __float128 b, __float128 e, Int_t x, Int_t y, __float128 em, __float128 tau, __float128 v)
{
   __float128 s = e*mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalLikeMod3(__float128 mu, Int_t x, __float128 bm, __float128 em, __float128 sde, __float128 sdb, Int_t what)
{
   __float128 f = 0.;
   __float128  v = sde * sde;
...
__float128 TRolke128::LikeMod3(__float128 mu, __float128 b, __float128 e, Int_t x, __float128 bm, __float128 em, __float128 u, __float128 v)
{
   __float128 s = e*mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalLikeMod4(__float128 mu, Int_t x, Int_t y, __float128 tau, Int_t what)
{
   __float128 f = 0.0;
...
__float128 TRolke128::LikeMod4(__float128 mu, __float128 b, Int_t x, Int_t y, __float128 tau)
{
   __float128 s = mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalLikeMod5(__float128 mu, Int_t x, __float128 bm, __float128 sdb, Int_t what)
{
   __float128 u = sdb * sdb;
   __float128 f = 0;
...
__float128 TRolke128::LikeMod5(__float128 mu, __float128 b, Int_t x, __float128 bm, __float128 u)
{
   __float128 s = mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalLikeMod6(__float128 mu, Int_t x, Int_t z, __float128 b, Int_t m, Int_t what)
{
   __float128 coef[4], roots[3];
   __float128 f = 0.;
   __float128 zm = __float128(z) / m;
...
__float128 TRolke128::LikeMod6(__float128 mu, __float128 b, __float128 e, Int_t x, Int_t z, Int_t m)
{
   __float128 s = e*mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalLikeMod7(__float128 mu, Int_t x, __float128 em, __float128 sde, __float128 b, Int_t what)
{
   __float128 v = sde * sde;
   __float128 f = 0.;
...
__float128 TRolke128::LikeMod7(__float128 mu, __float128 b, __float128 e, Int_t x, __float128 em, __float128 v)
{
   __float128 s = e*mu+b;
   __float128 lls = - s;
   if (x > 0) lls = x*Log128(s) - s - LogFactorial(x);
...
__float128 TRolke128::EvalPolynomial(__float128 x, const Int_t  coef[], Int_t N)
{
   const Int_t   *p;
   p = coef;
   __float128 ans = *p++;
...
__float128 TRolke128::EvalMonomial(__float128 x, const Int_t coef[], Int_t N)
{
   __float128 ans;
   const Int_t   *p;
...
__float128 TRolke128::LogFactorial(Int_t n)
...
__float128 TRolke128::Poisson128(__float128 x, __float128 par) {
   if (x<0)
      return 0;
   else if (x == 0.0)
      return 1./expq(par);
 ...
 __float128 TRolke128::PoissonI128(__float128 x, __float128 par) {
      Int_t ix = Int_t(x);
 ...
 __float128 TRolke128::Max128(__float128 a, __float128 b) {
   return (a > b) ? a : b;
 }
   // TMath::Max()

 __float128 TRolke128::Log128(__float128 a) {
   return logq(a);
 }
   // TMath::Log()
 ...
 __float128 TRolke128::Sqrt128(__float128 a) {
   return sqrtq(a);
 }
   // TMath::Sqrt()

 Bool_t TRolke128::RootsCubic128(const __float128 coef[4],__float128 &a, __float128 &b, __float128 &c) {
