...
//  and the syntax, consult TRolkeMinusFix128.cxx
//                  ------------------
//
...
#ifndef ROOT_TRolkeMinusFix128
#define ROOT_TRolkeMinusFix128
...
class TRolkeMinusFix128 //: public TObject
{
...
public:
   ...
   /* Constructor */
   TRolkeMinusFix128(__float128 CL = 0.9, Option_t *option = "");
   ...
   /* Get the bounding mode flag. True activates bounded mode. Read
      TRolkeMinusFix128.cxx and the references therein for details. */
